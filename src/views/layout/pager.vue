<template>
    <div class="pager">
        <span class="prev animate-link" @click="prev(pageInfo.curPage-1,pageInfo.pageSize)"></span>
        ...
        <span class="next animate-link" @click="next(pageInfo.curPage+1,pageInfo.pageCount,pageInfo.pageSize)">>></span>
    </div>
</template>
<script>
    export default {
