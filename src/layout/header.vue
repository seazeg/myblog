<template>
    <div class="header" :class="{'fold':isfold,'mgr':this.$route.name=='home',hide:this.$route.name=='write'||this.$route.name=='album'||this.$route.name=='photos'||this.$route.name=='upload'}">
